...
#-libraryjars z:\work\eclipse\_sourse__\sdk\platforms\android-19\android.jar
...
-printmapping objPro/classes-processed.map

# You can print out the seeds that are matching the keep options below.

#-printseeds objPro/classes-processed.seeds
